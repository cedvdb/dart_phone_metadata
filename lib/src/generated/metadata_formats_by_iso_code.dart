import "package:phone_number_metadata/phone_number_metadata.dart";const metadataFormatsByIsoCode = <IsoCode, PhoneMetadataFormats>{IsoCode.AC: [],IsoCode.AD: [PhoneMetadataFormat(
      ...
      pattern: r"(\d{3})(\d{4})",
      nationalPrefixFormattingRule: null,
      leadingDigits: ["[1-9]","1[1-9]|26|[3-9]|(?:10|2[0-57-9])(?:[0-8]|9[0-47-9])","1(?:0(?:[0-8]|9[0-47-9])|[1-9])|2(?:[0-57-9](?:[02-8]|1(?:0[1-9]|[1-9])|9[0-47-9])|6)|[3-9]"],
      format: r"$1 $2",
      intlFormat: r"NA",
    ),PhoneMetadataFormat(
      pattern: r"(\d{4})(\d{4})",
      ...
      nationalPrefixFormattingRule: r"$NP ($FG)",
      leadingDigits: ["7(?:1[0-8]|2[1-9])","7(?:1(?:[0-356]2|4[29]|7|8[27])|2(?:1[23]|[2-9]2))","7(?:1(?:[0-356]2|4[29]|7|8[27])|2(?:13[03-69]|62[013-9]))|72[1-57-9]2"],
      format: r"$1 $2 $3 $4",
      intlFormat: null,
    ),PhoneMetadataFormat(
